<template>
  <Section id="blog" class="text-typography_primary">
    <div
      class="border-t-2 pt-8 border-typography_primary flex flex-col md:flex-row items-center md:justify-between md:text-right mb-6 md:mb-8"
    >
      <ol
        itemscope
    ...
    <h1
      class="font-bold mb-4 md:mb-6 text-h3 leading-h3 md:text-h1 md:leading-h1 text-center md:text-left"
    >
      Blog
    </h1>
    <p class="mb-3 md:w-8/12 md:text-lg md:leading-lg text-center md:text-left">
      Lorem, ipsum dolodr sit amet consectetur adipisicing elit. Quos porro
